...
export default function AccessPage() {
  return (
    <section className="page-shell checkout-shell">
      ...
      <h1>LeadSprint opens automatically after checkout.</h1>
      <p className="lead">After a successful Stripe payment, LeadSprint verifies the purchase and unlocks the live builder in this browser. No complicated account setup is required.</p>
