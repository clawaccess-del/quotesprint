    ...
    <div className="page-shell founding-page">
      ...
      <section className="section" id="apply">
        <div className="trial-apply-card">
          ...
          <form className="trial-form" action="/api/founding-application" method="post">
            ...
            <p className="fine-print">Applications are sent privately to the LeadSprint team. The destination email is not shown publicly on the page.</p>
          </form>
        </div>
      </section>
    </div>
